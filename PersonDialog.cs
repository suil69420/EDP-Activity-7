...
namespace WindowsFormsApp2
{
    public partial class PersonDialog : Form
    {
        ...
        private void LoadPersonData()
        {
            ...
            var dt = DBHelper.ExecuteQuery(sql, new MySqlParameter("@id", PersonId));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txtContactNumber.Text = row["person_contact_num"].ToString();
            }
        }
        ...
        {
            var nextId = Convert.ToInt32(DBHelper.ExecuteScalar("SELECT COALESCE(MAX(person_id), 0) + 1 FROM person"));
            var sql = "INSERT INTO person (person_id, first_name, last_name, person_contact_num) VALUES (@id, @fn, @ln, @contact)";
        ...
        {
            var sql = "UPDATE person SET first_name = @fn, last_name = @ln, person_contact_num = @contact WHERE person_id = @id";
            DBHelper.ExecuteNonQuery(sql,
                new MySqlParameter("@fn", txtFirstName.Text.Trim()),
                new MySqlParameter("@ln", txtLastName.Text.Trim()),
                new MySqlParameter("@contact", txtContactNumber.Text.Trim()),
                new MySqlParameter("@id", PersonId));
        ...
        private void InitializeComponent()
        {
            ...
            this.btnSave.Location = new System.Drawing.Point(195, 170);
